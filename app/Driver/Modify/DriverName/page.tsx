        ...
        <div className="flex max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden border border-gray-300">
            <div className="w-full h-full">
                <div className="flex mt-2 justify-between">
                    <h2 className="w-1/2 text-sm m-2 font-bold">Name: </h2>
                ...
                <div className="flex mt-2 justify-between m-2">
                    <input 
                        ...
                        className="border p-2 rounded"
                    />
                    <Link href="/Driver/Modify/DriverName" className="bg-blue-500 text-white font-bold py-2 px-4 rounded m-2 hover:bg-black-main hover:text-white">
                    Modify
                    </Link> 
                </div>              
            </div>
